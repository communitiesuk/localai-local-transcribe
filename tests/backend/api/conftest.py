...
from common.types import TranscriptionCreateRequest, TranscriptionPatchRequest, DialogueEntry
import pytest
import datetime
...
def mock_storage_service_recording(mocker):
    ...
    service.generate_presigned_url_put_object = AsyncMock(
        return_value="https://example.s3.amazonaws.com/put-123"
    )

    service.generate_presigned_url_get_object = AsyncMock(
...
def mock_transcription():
    ...
    transcription.created_datetime = datetime.datetime(2024, 1, 15, 10, 30, 0)
...
def transcription_patch_request():
    ...
    return TranscriptionPatchRequest(
        ...
        dialogue_entries=[
            {
                "speaker": "Alice",
                "text": "Updated dialogue 1",
                "start_time": 0.0,
                "end_time": 5.5
            },
            {
                "speaker": "Bob",
                "text": "Updated dialogue 2",
                "start_time": 5.5,
                "end_time": 12.3
            },
        ]
