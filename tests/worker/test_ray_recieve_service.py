...
async def test_process_with_transcript(transcription_service, transcription_queue, llm_queue, monkeypatch):
    # transcription_queue.receive_message.return_value = make_mocked_messages()
...
@pytest.mark.asyncio
async def test_process_without_transcript_requeue(transcription_service, transcription_queue, monkeypatch):
    transcription_queue.receive_message.return_value = [(MINUTE_MESSAGE, RECEIPT_HANDLE)]
