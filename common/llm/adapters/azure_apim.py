...
class AzureAPIMModelAdapter(ModelAdapter):
    ...
    async def structured_chat[T](
        ...
        *,
        ...
        # usage carries prompt_tokens_details.cached_tokens, so prompt-prefix cache hits are
        # measurable rather than inferred from how the prompt is laid out.
        logger.info("APIM SUCCESS: structured_chat - usage=%s", response.usage)
