...
if __name__ == "__main__":
    ...
    parser.add_argument("--num-alternatives", type=int, default=2, help="Number of counterfactual alternatives")
    ...
    report = asyncio.run(evaluate_counterfactual(reference, transcript_text, chatbot, args.num_alternatives))
