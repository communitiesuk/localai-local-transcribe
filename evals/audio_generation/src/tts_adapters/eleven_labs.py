...
from evals.audio_generation.src.utils.parsing_utils import build_pattern, extract_speakers, save_audio, get_transcripts
...
class ElevenLabsAdapter(TTSAdapter):
    ...
    def generate_audio(self, transcript_file: str) -> None:
        if not self.api_key:
            logger.warning("No Eleven Labs API key provided. Audio generation will be skipped.")
            return    
