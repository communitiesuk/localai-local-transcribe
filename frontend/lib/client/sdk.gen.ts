...
import type {
  ...
  AcceptTermsOfUseUsersTermsOfUsePostErrors,
  AcceptTermsOfUseUsersTermsOfUsePostResponses,
 ...
 * Accept Terms Of Use
 */
export const acceptTermsOfUseUsersTermsOfUsePost = <
  ThrowOnError extends boolean = false,
>(
  options?: Options<AcceptTermsOfUseUsersTermsOfUsePostData, ThrowOnError>
) =>
  (options?.client ?? client).post<
    AcceptTermsOfUseUsersTermsOfUsePostResponses,
    AcceptTermsOfUseUsersTermsOfUsePostErrors,
    ThrowOnError
  >({ url: '/users/terms-of-use', ...options })
