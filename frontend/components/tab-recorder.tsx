...
function TabRecorder({
  ...
  // Fix: mirror streamRef into state so JSX reads it safely without touching .current during render
  ...
  const stopAllTracks = useCallback(() => {
    ...
    // Keep state in sync with ref when clearing
    setStream(null)
  ...
  const startRecording = useCallback(async () => {
    ...
    try {
      ...
      // Keep state in sync with ref when setting
