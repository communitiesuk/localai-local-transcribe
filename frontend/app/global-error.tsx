...
// layout's style imports will not have run. The banner and footer are inlined
// rather than using <Header /> and <GovFooter />, because those depend on
// constants, icons and providers that may not be available once the root
// layout has failed.
