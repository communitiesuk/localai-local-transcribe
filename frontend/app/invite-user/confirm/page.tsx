          ...
          <div className="govuk-grid-row">
            <div className="govuk-grid-column-three-quarters">
              ...
              <p className="govuk-body govuk-!-margin-bottom-5">
                ...
                email address stated above. They will appear as ‘Pending’ in
                your system until they complete their onboarding process.
              </p>

              <p className="govuk-body govuk-!-margin-bottom-5">
                They will be granted standard user access by default. If you
                would like to grant them admin permissions you can change this
