...
#
# Peering to the hub and the private endpoints themselves are not in this root. Send the
# Azure team the virtual network resource ID after apply; peering is a pair of objects and
# they create the hub side. Endpoints come after the peer exists so the spoke can use hub DNS.
